...
execute_process(
  COMMAND "/usr/bin/git" show-ref 5e43547e9d7099ac0759b75fa5e4e2115ca9cc9f
  WORKING_DIRECTORY "/home/jason/splisplash/cmake-build-debug/extern/GenericParameters/src/Ext_GenericParameters"
...
if("${show_ref_output}" MATCHES "refs/remotes/5e43547e9d7099ac0759b75fa5e4e2115ca9cc9f")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "5e43547e9d7099ac0759b75fa5e4e2115ca9cc9f")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "5e43547e9d7099ac0759b75fa5e4e2115ca9cc9f")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 5e43547e9d7099ac0759b75fa5e4e2115ca9cc9f
  WORKING_DIRECTORY "/home/jason/splisplash/cmake-build-debug/extern/GenericParameters/src/Ext_GenericParameters"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jason/splisplash/cmake-build-debug/extern/GenericParameters/src/Ext_GenericParameters/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jason/splisplash/cmake-build-debug/extern/GenericParameters/src/Ext_GenericParameters/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
