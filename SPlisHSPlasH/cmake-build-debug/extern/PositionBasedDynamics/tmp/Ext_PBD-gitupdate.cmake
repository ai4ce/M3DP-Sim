...
execute_process(
  COMMAND "/usr/bin/git" show-ref b142aad449337cc091611d79a5f1fff85ccc6c40
  WORKING_DIRECTORY "/home/jason/splisplash/cmake-build-debug/extern/PositionBasedDynamics/src/Ext_PBD"
...
if("${show_ref_output}" MATCHES "refs/remotes/b142aad449337cc091611d79a5f1fff85ccc6c40")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "b142aad449337cc091611d79a5f1fff85ccc6c40")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "b142aad449337cc091611d79a5f1fff85ccc6c40")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 b142aad449337cc091611d79a5f1fff85ccc6c40
  WORKING_DIRECTORY "/home/jason/splisplash/cmake-build-debug/extern/PositionBasedDynamics/src/Ext_PBD"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/jason/splisplash/cmake-build-debug/extern/PositionBasedDynamics/src/Ext_PBD/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/jason/splisplash/cmake-build-debug/extern/PositionBasedDynamics/src/Ext_PBD/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
